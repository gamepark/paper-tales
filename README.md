...
use [our template on Github](https://github.com/gamepark/board-paper-tales)
...
- `PaperTales` => `NameOfYourGame`
- `paper-tales` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [PaperTalesRules.ts](/rules/src/PaperTalesRules.ts)
