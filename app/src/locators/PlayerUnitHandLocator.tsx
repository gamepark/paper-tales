...
export class PlayerUnitHandLocator extends HandLocator {
  ...
  locationDescription = new DropAreaDescription({ width: unitCardDescription.width * 2, height: unitCardDescription.height + 2, borderRadius: unitCardDescription.borderRadius })
