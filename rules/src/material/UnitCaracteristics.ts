...
export const unitCardCaracteristics: Record<Unit, UnitPattern> = {
    ...
    [Unit.Treefolk]: { cost: 1, power: 3, resources:{type:[Resources.Food]} },  // OK
    [Unit.Necromancer]: { cost: 1, power: 4},
    [Unit.Veteran]: { cost: 0, power: 3},
    [Unit.Miner]: { cost: 1, power: 2, resources:{type:[Resources.Diamond]}},   // OK
    ...
    [Unit.ForestSpirit]: { cost: 3, power: 3, resources:{type:[Resources.Wood, Resources.Wood, Resources.Wood]}},   // OK
    ...
    [Unit.Farmer]: { cost: 0, power: 1, resources:{type:[Resources.Food]}}, // OK
    [Unit.Kraken]: { cost: 6, power: 9},
    [Unit.Demon]: { cost: 2, power: 7},
    [Unit.ForestChild]: { cost: 1, power: 1, resources:{type:[Resources.Wood, Resources.Food]}},    // OK
    [Unit.Ogre]: { cost: 2, power: 2},
    [Unit.Hunter]: { cost: 0, power: 2, resources:{type:[Resources.Diamond], condition:{onLane:LaneType.FrontLane}}},       // OK
    ...
    [Unit.Adventurer]: { cost: 0, power: 2, resources:{type:[Resources.Diamond], condition:{perAgeToken:true}}}     // OK
